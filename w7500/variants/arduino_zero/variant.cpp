...
const void* g_apTCInstances[1/*TCC_INST_NUM+TC_INST_NUM*/]={/* TCC0, TCC1, TCC2, TC3, TC4, TC5 */} ;
...
/////// Ãß°¡ µÊ ½ÃÀÛ
#if 1
struct _DIGITAL_PIN_TBL digital_pin_tbl[] =
{

#if 0   // 1 : W7500P, 0 : W7500
    {0x00000000, 0x00,  14},  // D00  GPIOA.14
    {0x00000000, 0x00,  13},  // D01  GPIOA.13

//    {0x02000000, 0x80,   1},  // D02  GPIOC.01
//    {0x02000000, 0x80,   0},  // D03  GPIOC.00
    {0x02000000, 0x80,   3},  // D02  GPIOC.03
    {0x02000000, 0x80,   2},  // D03  GPIOC.02

    {0x00000000, 0x00,   2},  // D04  GPIOA.02
    {0x00000000, 0x00,   1},  // D05  GPIOA.01
    {0x00000000, 0x00,   0},  // D06  GPIOA.00

//    {0x02000000, 0x80,   6},  // D07  GPIOC.06
//    {0x02000000, 0x80,   7},  // D08  GPIOC.07
//    {0x02000000, 0x80,   4},  // D09  GPIOC.04
    {0x00000000, 0x00,   12},  // D07  GPIOA.12
    {0x00000000, 0x00,   11},  // D08  GPIOA.11
    {0x02000000, 0x80,   1},  // D09  GPIOC.01

    {0x00000000, 0x00,   5},  // D10  GPIOA.05
    {0x00000000, 0x00,   8},  // D11  GPIOA.08
    {0x00000000, 0x00,   7},  // D12  GPIOA.07
    {0x00000000, 0x00,   6},  // D13  GPIOA.06
    {0x00000000, 0x00,  10},  // D14  GPIOA.10
    {0x00000000, 0x00,   9},  // D15  GPIOA.09
//////// for SDIO
    {0x01000000, 0x40,   0},  // D16  GPIOB.00
    {0x01000000, 0x40,   1},  // D17  GPIOB.01
    {0x01000000, 0x40,   2},  // D18  GPIOB.02
    {0x01000000, 0x40,   3}   // D19  GPIOB.03
...
struct _PWM_PIN_TBL pwm_pin_tbl[] =
{
    ...
    { 0, 0x000, 0x02000000,  0, 0x80, 0x2},  // -    A00  GPIOC.00      A01  GPIOC.01  // toneÀ¸·Î »ç¿ëµÊ
    ...
    { 1, 0x100, 0x02000000,  1, 0x80, 0x2},  // -    A01  GPIOC.01  // toneÀ¸·Î »ç¿ëµÊ
    { 3, 0x300, 0x02000000,  3, 0x80, 0x2},  // -    A03  GPIOC.03
///////////// test
    { 0, 0x000, 0x02000000,  0, 0x80, 0x2}   // D3   A00  GPIOC.00
#endif
