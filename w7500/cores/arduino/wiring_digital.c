...
//    *(volatile unsigned long *) 0x4000D000 = '0';
    *(volatile unsigned int *)(0x42000010 + digital_pin_tbl[ulPin].port) |= 1 << digital_pin_tbl[ulPin].pin_num;   //GPIOx->OUTENSET
	}
...
//    *(volatile unsigned long *) 0x4000D000 = '1';
    ...
    *(volatile unsigned int *)(0x42000004 + digital_pin_tbl[ulPin].port) &= ~(1 << digital_pin_tbl[ulPin].pin_num);   //GPIOx->OUTENSET
	} else {
...
{
    if( (*(volatile unsigned int *)(0x42000000 + digital_pin_tbl[ulPin].port) & (1 << digital_pin_tbl[ulPin].pin_num)) == 0)              //GPIOx->DATA
    {
       return LOW;
    }
	  return HIGH;
