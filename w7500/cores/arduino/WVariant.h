...
/////// 추가 됨 시작
// 구조체 선언
struct _DIGITAL_PIN_TBL
{
    // Base 0x42000000  a 0x00000000  b 0x01000000  c 0x02000000  d 0x03000000  
    unsigned int port;
    // Base 0x41002000  a 0x00  b 0x40  c 0x80  d 0xC0  
    unsigned int af_port;
    // Port 0 ~ 15
    unsigned int pin_num; 
};

extern struct _DIGITAL_PIN_TBL digital_pin_tbl[];
...
struct _PWM_PIN_TBL
{
    ...
    // PWM Number Base 0x40005000  0 0x000, 1 0x100, 2 0x200, 3 0x300, 4 0x400, 5 0x500, 6 0x600, 7 0x700  
    unsigned int pwm_num;
    // Port Number Base 0x42000000  a 0x00000000  b 0x01000000  c 0x02000000  d 0x03000000  
    unsigned int port_num;
    // Port 0 ~ 15
    unsigned int pin_num; 
    // Base 0x41002000  a 0x00  b 0x40  c 0x80  d 0xC0  
    unsigned int af_base;
    // 00, 01, 10, 11  
    unsigned int af_num;
};
